...
def compute_firing_rate_over_time(
    ...
    times : 1D array
        times at which FR was determined
        center of each bin
    ...
    # End reflection (reflect based on distance to end)
...
def plot_nwb_firing_rate_over_time_over_time(nwbfile, unit_ix, step=0.1, axs=None, ci=95):
    """
    ...
    axs = plot_firing_rate_over_time_over_time(FRs, mean_FR, step=0.1, axs = axs, unit_ix = unit_ix, ci=ci)
